...
export default function CourseChipNode({ course }: CourseChipNodeProps) {
  return (
    <div className="w-40 rounded-xl border border-yellow-400/30 bg-yellow-400/10 px-3 py-2 text-left transition hover:border-yellow-300 hover:bg-yellow-400/20">
